...
#### Featured projects
- **Ai EDA** *(closed-source / internal use)* — An LLM-powered AI coding agent tailored for enterprise internal use in Verilog/EDA workflows. Automates RTL design, testbench generation, and EDA tool orchestration, with integrated PPA (Power, Performance, Area) optimization capabilities for hardware implementation, enabling an agentic development experience for hardware teams.
